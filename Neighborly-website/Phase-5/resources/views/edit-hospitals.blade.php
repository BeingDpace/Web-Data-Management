                            ...
                            <form action="{{route("hospitals.update",$hospital->id)}}" method="post" >
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" name="hospital_name"
                                               id="hospitalnameinput" value="@if(isset($hospital)){{$hospital->hospital_name}}@endif">
                                        <label for="citynameinput">City</label>
                                        <input required type="text" class="form-control" name="city_name"
                                               id="citynameinput" value="@if(isset($hospital)){{$hospital->city_name}}@endif">
                                        <label for="countrynameinput">Select Country</label>
                                        <select required type="text" class='form-control' id="countrynameinput"
                                                name="country_name">
