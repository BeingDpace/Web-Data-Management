...
<body>
  ...
  <header class="main-header">
      <div class="container">
        <div class="main-logo">
          <a href="{{ url('/users') }}">Neighbor.ly</a>
        </div>
        
        <nav class="main-nav">
          <ul>
            <li><a href="{{ url('/users/media') }}">Upload Files</a></li>
            <li><a href="{{ url('/users/places') }}">Search Places</a></li>
            <li><a href="{{ url('/users/tips') }}">Tips</a></li>
            <li><a href="{{ url('/users/chat') }}">Chat</a></li>
            <li><a class="button" href="{{ url('/logout') }}">Log out</a></li>
          </ul>
        </nav>
      </div>
  </header><!-- /.main-header -->
    ...
    @if( auth()->check() )
    <p class="login_status">Logged in as 
        {{ auth()->user()->fname }}
        </p>
      @endif
