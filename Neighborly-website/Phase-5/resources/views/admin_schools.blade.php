        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{url('admin-school-form')}}" class="btn btn-primary float-right"> Add School
              </a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    while($school_row = mysqli_fetch_array($query)){
                        ...
                        echo "<td>
                        <a href='edit_admin_schools.php?eid={$school_row['school_id']}' class='btn btn-primary'> Edit </a>
                        <a href='admin_schools.php?did={$school_row['school_id']}' class='btn btn-danger'> Delete</a>
                        </td>";
                        echo"</tr>";
                    }
                    ?>
