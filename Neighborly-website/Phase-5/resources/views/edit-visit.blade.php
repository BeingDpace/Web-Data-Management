                            ...
                            <form method="post" action="{{route("visits.update",$visit->id)}}">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" value="@if(isset($visit)){{$visit->place_name}}@endif" class="form-control" name="place_name" id="placenameinput">
                                        <label for="citynameinput">City</label>
                                        <input required type="text" value="@if(isset($visit)){{$visit->city_name}}@endif" class="form-control" name="city_name" id="citynameinput">
