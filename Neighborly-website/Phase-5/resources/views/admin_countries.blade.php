        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{ url('admin-countries-form') }}" class="btn btn-primary float-right"> Add Country
              </a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    if(isset($_GET['did'])){
                        $did = $_GET['did'];
                        $delete_query = mysqli_query($conn, "delete from country where country_id = '{$did}'") or die(mysqli_error($conn));
                        if ($delete_query){
                    ...
                    $i = 0;
                    while($country_row = mysqli_fetch_array($query)){
                        $i++;
                        echo "<tr>";
                        echo "<td>$i</td>";
                        echo "<td>{$country_row["country_name"]} </td>";
                        echo "<td>{$country_row["continent_name"]} </td>";
                        echo "<td>
                        <a href='edit_admin_countries.php?eid={$country_row['country_id']}' class='btn btn-primary'> Edit </a>
                        <a href='admin_countries.php?did={$country_row['country_id']}' class='btn btn-danger'> Delete</a>
                        </td>";
                        echo"</tr>";
                    }
                    ?>
