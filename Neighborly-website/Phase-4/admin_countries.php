    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="admin_countries.php" class="nav-link active">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Countries
              </p>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="admin-countries-form.php" class="btn btn-primary float-right"> Add Country
              </a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    while($country_row = mysqli_fetch_array($query)){
                        ...
                        echo "<td>
                        <a href='edit-countries.php?eid={$country_row['country_id']}' class='btn btn-primary'> Edit </a>
