        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="visit-form.php" class="btn btn-primary float-right"> Add Place
              </a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  while($place_row = mysqli_fetch_array($query)){
                      ...
                      echo "<td>
                        <a href='edit-visit.php?eid={$place_row['place_id']}' class='btn btn-primary'> Edit </a>
                        <a href='visit.php?did={$place_row['place_id']}' class='btn btn-danger'> Delete</a>
                        </td>";
                      echo"</tr>";
                  }
                  ?>
