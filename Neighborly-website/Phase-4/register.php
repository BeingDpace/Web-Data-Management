...
<body>
    <div class="register-page">
        ...
        <div class="form">
            <form class="register" action="_email/send-email.php" method="POST">
                <div class="name">
                ...
                <div class="other_info">
                    ...
                    <input type="date" name="date" placeholder="date" required title="Date of Birth"/>
                    <select id="user_type" name="user_type" required title="Are you an Immigrant or a Visitor?">
                        <option value="" selected>Are you an Immigrant or a Visitor?</option>
                        <option value="Immigrant">Immigrant</option>
                        <option value="Visitor">Visitor</option>
                    </select>
                    <select id="country" name="country" required title="Select Home Country">
                ...
                <p class="message">already a user? <a href="login.php">Login</a></p>
            </form>
